...
object FP32RoPE2LaneV2Top extends App {
  (new ChiselStage).emitVerilog(new multiLaneRoPEmodule(N = 1, Index = 0, LutSize = 12, LutHalfSizeHEX = 0x45000000, doublePi = 4096, OneAndHalfPi = 3072, Pi = 2048, halfPi = 1024))
}
