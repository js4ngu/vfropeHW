...
module GenericSerializer_TLBeatw67_f32(	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
  ...
  input  [64:0] io_in_bits_payload,	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:10:14]
  ...
  wire [0:0][31:0] _GEN = {32'h0};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:24:26]
  ...
  wire             _io_out_valid_output = io_in_valid | (|beat);	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:20:21, :23:{31,39}]
  wire [3:0][31:0] _GEN_0 = {_GEN, {{data_2}, {data_1}, {32'h0}}};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :24:26]
  wire             _GEN_1 = io_out_ready & _io_out_valid_output;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:23:31, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
    if (_GEN_1 & _io_out_bits_flit_T) begin	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :22:39, :26:22, :28:25, :29:12, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      data_1 <= io_in_bits_payload[61:30];	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :29:34]
      data_2 <= {29'h0, io_in_bits_payload[64:62]};	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:19:17, :29:34]
    end
    if (reset)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7]
      ...
      if (beat == 2'h2)	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :20:21, :27:22]
        beat <= 2'h0;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :20:21]
      else	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:27:22]
        beat <= beat + 2'h1;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :20:21, :27:53]
    end
  end // always @(posedge)
  ...
  assign io_out_valid = _io_out_valid_output;	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :23:31]
  assign io_out_bits_flit = _io_out_bits_flit_T ? {io_in_bits_payload[29:0], io_in_bits_head, io_in_bits_tail} : _GEN_0[beat];	// @[generators/testchipip/src/main/scala/serdes/Serdes.scala:8:7, :20:21, :22:39, :24:{26,52}]
endmodule
