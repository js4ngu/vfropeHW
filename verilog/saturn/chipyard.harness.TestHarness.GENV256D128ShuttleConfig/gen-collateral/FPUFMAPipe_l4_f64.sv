...
module FPUFMAPipe_l4_f64(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (io_in_valid) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
      ...
      in_in3 <= io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : (io_in_bits_in1 ^ io_in_bits_in2) & 65'h10000000000000000;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :711:{32,50,57}, :714:8, :716:{21,37,46}]
    end
    if (_fma_io_validout) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
      io_out_pipe_b_data <= ({65{_fma_io_out[63:61] != 3'h7}} | 65'h1EFEFFFFFFFFFFFFF) & _fma_io_out;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :413:27, :414:10, :719:19, src/main/scala/chisel3/util/Valid.scala:142:26]
