...
module LoadSegmenter(	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
  ...
  input  [7:0]   io_op_vstart,	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:12:14]
  input  [8:0]   io_op_vl,	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:12:14]
  ...
  reg  [7:0]   r_eidx;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:28:19]
  ...
  wire [7:0]   eidx = r_head ? io_op_vstart : r_eidx;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:28:19, :29:23, :31:17]
  ...
  wire [10:0]  _GEN = {9'h0, io_op_elem_size};	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:35:64]
  wire [10:0]  _incr_T_3 = {3'h0, (|_seg_ready_T) ? {5'h0, sidx} : eidx} << _GEN;	// @[generators/saturn/src/main/scala/common/Bundles.scala:33:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:31:17, :32:17, :35:{29,43,64}]
  ...
  wire [8:0]   next_eidx = {1'h0, eidx} + {4'h0, (|_seg_ready_T) ? 5'h1 : incr};	// @[generators/saturn/src/main/scala/common/Bundles.scala:33:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :31:17, :35:95, :36:{22,36}, :38:24]
  ...
  wire [10:0]  _io_compactor_bits_head_T = {3'h0, eidx} << _GEN;	// @[generators/saturn/src/main/scala/common/Bundles.scala:33:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:31:17, :35:64, :46:36]
  wire [11:0]  _io_compactor_bits_tail_T = {3'h0, io_op_vl} << io_op_elem_size;	// @[generators/saturn/src/main/scala/common/Bundles.scala:33:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:47:55]
  ...
  always @(posedge clock) begin	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
    if (_GEN_1)	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:88:19]
      r_eidx <= next_eidx[7:0];	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:28:19, :38:24, :90:12]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
    ...
    initial begin	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
        ...
        r_eidx = _RANDOM[/*Zero width*/ 1'b0][7:0];	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :28:19]
        r_head = _RANDOM[/*Zero width*/ 1'b0][8];	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :28:19, :29:23]
        r_sidx = _RANDOM[/*Zero width*/ 1'b0][11:9];	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :28:19, :30:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
