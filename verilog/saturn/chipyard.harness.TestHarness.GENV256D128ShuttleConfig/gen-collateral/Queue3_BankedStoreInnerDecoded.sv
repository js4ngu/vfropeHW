...
module Queue3_BankedStoreInnerDecoded(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [127:0] _ram_data_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    if (reset) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      if (do_enq) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:263:27, :298:17, :301:{26,35}]
      ...
      if (do_deq) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:264:27, :298:17, :300:14]
  ...
  ram_data_3x128 ram_data_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_data = empty ? io_enq_bits_data : _ram_data_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19]
endmodule
