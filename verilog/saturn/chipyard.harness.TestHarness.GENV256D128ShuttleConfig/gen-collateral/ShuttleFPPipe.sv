...
module ShuttleFPPipe(	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7]
  ...
  input         io_s2_kill,	// @[generators/shuttle/src/main/scala/exu/FPU.scala:17:14]
  ...
  reg         io_out_valid_r_7;	// @[generators/shuttle/src/main/scala/exu/FPU.scala:101:22]
  reg         io_out_valid_r_8;	// @[generators/shuttle/src/main/scala/exu/FPU.scala:101:22]
  ...
  always @(posedge clock) begin	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7]
    ...
    io_out_valid_r_7 <= io_s2_kill;	// @[generators/shuttle/src/main/scala/exu/FPU.scala:101:22]
    io_out_valid_r_8 <= io_out_valid_r_7;	// @[generators/shuttle/src/main/scala/exu/FPU.scala:101:22]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7]
    ...
    initial begin	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7]
        ...
        io_out_valid_r_7 = _RANDOM[1'h0][7];	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7, :99:33, :101:22]
        io_out_valid_r_8 = _RANDOM[1'h0][8];	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7, :99:33, :101:22]
  ...
  assign io_out_valid = io_out_valid_r_3 & ~io_out_valid_r_6 & ~io_out_valid_r_8;	// @[generators/shuttle/src/main/scala/exu/FPU.scala:15:7, :99:33, :100:{8,22}, :101:{5,8,22}]
