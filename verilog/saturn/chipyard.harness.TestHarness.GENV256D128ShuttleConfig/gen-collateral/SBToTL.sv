...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire            _rdTxValid_T = sbState == 3'h3;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :299:25, :353:21]
  wire            _io_wrDone_T = sbState == 3'h4;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :299:62]
  wire            _q_io_deq_ready_T_2 = _rdTxValid_T | _io_wrDone_T;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,50,62}]
  ...
  wire [115:0]    _GEN_6 = {io_addrIn[127:29], io_addrIn[28:12] ^ 17'h10020};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire [99:0]     _GEN_7 = {io_addrIn[127:32], io_addrIn[31:28] ^ 4'h8};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire            _io_rdLegal_output = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | {io_addrIn[127:17], ~(io_addrIn[16])} == 112'h0 | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            _io_wrLegal_output = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            _nodeOut_a_valid_T = sbState == 3'h1;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :322:18, :350:21]
  wire            _nodeOut_a_valid_T_1 = sbState == 3'h2;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :338:29, :351:21]
  wire            rdTxValid = _rdTxValid_T & _d_q_io_deq_valid & _q_io_deq_ready_T_2;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,50}, :339:70, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire            _GEN_8 = sbState == 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :349:19, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:264:74]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
      if (~reset & ~(_GEN_8 | _nodeOut_a_valid_T | _nodeOut_a_valid_T_1 | _rdTxValid_T | _io_wrDone_T)) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,62}, :322:18, :338:29, :349:19, :373:12, :376:45]
  ...
  `endif // not def SYNTHESIS
  wire            wrTxValid = _nodeOut_a_valid_T_1 & nodeOut_a_valid & auto_out_a_ready;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:338:{29,69}, :366:52]
  wire            _counter_T_2 = wrTxValid | rdTxValid;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:338:69, :339:70, :341:31]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
      sbState <= 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:264:74]
      ...
      if (_GEN_8) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:349:19]
        if (io_rdEn & _io_rdLegal_output)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:350:30, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
          sbState <= 3'h1;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :350:21]
        else if (io_wrEn & _io_wrLegal_output)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:351:30, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
          sbState <= 3'h2;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :351:21]
      end
        ...
        if (nodeOut_a_valid & auto_out_a_ready)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:353:35, :366:52]
          sbState <= 3'h3;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :353:21]
      end
      else if (_nodeOut_a_valid_T_1) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:338:29]
        if (wrTxValid & txLast)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:338:69, :340:29, :355:32]
          sbState <= 3'h4;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :299:62]
      end
      else if (_rdTxValid_T ? rdTxValid & txLast : _io_wrDone_T & _d_q_io_deq_valid & _q_io_deq_ready_T_2)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :299:{25,50,62}, :339:70, :340:29, :356:49, :357:{15,21,32}, :358:50, :359:{15,21}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
        sbState <= 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:264:74]
      if (_counter_T_2 & txLast)	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:340:29, :341:{31,45}]
        ...
        counter <= counter + 4'h1;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:307:26, :342:63, :345:45]
    end
  end // always @(posedge)
  ...
  Queue2_TLBundleD_a32d8s1k4z4u d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_deq_ready        (_q_io_deq_ready_T_2),	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:50]
  ...
  assign auto_out_a_bits_data = _nodeOut_a_valid_T ? 8'h0 : _GEN[counter[2:0]];	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :301:29, :307:26, :310:{15,33}, :322:{18,42,54}, :323:54]
  assign io_rdLegal = _io_rdLegal_output;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  assign io_wrLegal = _io_wrLegal_output;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  assign io_rdDone = rdTxValid & txLast;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :339:70, :340:29, :362:29]
  assign io_wrDone = _io_wrDone_T & _d_q_io_deq_valid & _q_io_deq_ready_T_2;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :299:{50,62}, :363:71, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign io_rdLoad_0 = rdTxValid & counter == 4'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_1 = rdTxValid & counter == 4'h1;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_2 = rdTxValid & counter == 4'h2;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_3 = rdTxValid & counter == 4'h3;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_4 = rdTxValid & counter == 4'h4;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_5 = rdTxValid & counter == 4'h5;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_6 = rdTxValid & counter == 4'h6;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
  assign io_rdLoad_7 = rdTxValid & counter == 4'h7;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, :307:26, :339:70, :345:{33,45}]
