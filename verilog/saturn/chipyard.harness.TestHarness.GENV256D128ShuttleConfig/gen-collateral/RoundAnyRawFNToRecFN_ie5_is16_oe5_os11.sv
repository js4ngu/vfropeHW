...
module RoundAnyRawFNToRecFN_ie5_is16_oe5_os11(	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:48:5]
  ...
  input  [16:0] io_in_sig,	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:58:16]
  ...
  wire        anyRound = io_in_sig[4] | (|(io_in_sig[3:0]));	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:117:{26,60}, :164:40, :166:36]
  ...
  wire [12:0] roundedSig = _overflow_roundMagUp_T & io_in_sig[4] | roundMagUp & anyRound ? {1'h0, io_in_sig[16:5]} + 13'h1 & {12'hFFF, ~(roundingMode_near_even & io_in_sig[4] & ~(|(io_in_sig[3:0])))} : {1'h0, io_in_sig[16:6], io_in_sig[5] | io_roundingMode == 3'h6 & anyRound};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:90:53, :95:53, :98:42, :116:66, :117:{26,60}, :164:40, :166:36, :169:{38,67}, :170:31, :171:29, :173:16, :174:{49,57}, :175:{21,25,64}, :176:30, :177:35, :180:47, :181:42]
  wire [7:0]  sRoundedExp = {io_in_sExp[6], io_in_sExp} + {6'h0, roundedSig[12:11]};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:173:16, :185:{40,54}, :278:16]
  wire        overflow = ~io_in_isZero & $signed(sRoundedExp[7:4]) > 4'sh2;	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:185:40, :196:{30,50}, :237:64, :238:32]
