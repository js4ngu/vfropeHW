...
module Queue2_ScalarWrite(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input         io_enq_bits_fp,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [1:0]  io_enq_bits_size,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [4:0]  io_enq_bits_rd,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input         io_deq_ready,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_valid,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [63:0] io_deq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_bits_fp,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [1:0]  io_deq_bits_size,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [4:0]  io_deq_bits_rd	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
);
  ...
  ram_2x72 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_rd, io_enq_bits_size, io_enq_bits_fp, io_enq_bits_data})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  );
  ...
  assign io_deq_bits_fp = _ram_ext_R0_data[64];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_size = _ram_ext_R0_data[66:65];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_rd = _ram_ext_R0_data[71:67];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
