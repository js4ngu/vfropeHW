...
module DivSqrtRawFN_small_e8_s24(	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
  ...
  wire [23:0] _fractB_Z_T_4 = inReady & ~io_sqrtOp ? {io_b_sig[22:0], 1'h0} : 24'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :226:33, :271:33, :342:{16,25,73,90}]
  ...
  wire [26:0] rem = {1'h0, inReady & ~oddSqrt_S ? {io_a_sig, 1'h0} : 26'h0} | (_sigX_Z_T_7 ? {io_a_sig[23:22] - 2'h1, io_a_sig[21:0], 3'h0} : 27'h0) | (inReady ? 27'h0 : {rem_Z, 1'h0});	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5, :225:33, :226:33, :243:29, :292:32, :352:{12,21,24,47,57}, :353:{12,21}, :354:{16,27,56}, :355:27, :358:11, :359:{12,29}]
  wire [25:0] _trialTerm_T_3 = inReady & ~io_sqrtOp ? {io_b_sig, 1'h0} : 26'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :226:33, :271:33, :352:12, :362:{12,21,48}]
  wire [25:0] _trialTerm_T_9 = {_trialTerm_T_3[25], _trialTerm_T_3[24:0] | {inReady & io_sqrtOp & ~(io_a_sExp[0]), 24'h0}} | (_sigX_Z_T_7 ? 26'h2800000 : 26'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :291:{35,48}, :342:16, :352:12, :353:21, :362:{12,74}, :363:{12,21,74}, :364:12]
  wire [28:0] trialRem = {2'h0, rem} - {2'h0, {1'h0, _trialTerm_T_9[25], _trialTerm_T_9[24] | ~inReady & ~sqrtOp_Z, _trialTerm_T_9[23:0] | (inReady ? 24'h0 : fractB_Z)} | (~inReady & sqrtOp_Z ? {sigX_Z, 1'h0} : 27'h0)};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5, :225:33, :226:33, :228:29, :236:29, :245:29, :340:23, :342:16, :353:12, :358:11, :363:74, :364:74, :365:{12,74}, :366:{23,26,74}, :367:{12,23,44}, :368:29]
  ...
  wire [25:0] _sigX_Z_T_3 = inReady & ~io_sqrtOp ? {newBit, 25'h0} : 26'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :271:33, :352:12, :363:12, :369:23, :394:{16,25,50}]
  wire [24:0] _GEN_0 = _sigX_Z_T_3[24:0] | {inReady & io_sqrtOp, 24'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :342:16, :394:{16,74}, :395:{16,25}]
  always @(posedge clock) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
    if (reset) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
      ...
      cycleNum <= {_cycleNum_T_15[4:1], _cycleNum_T_15[0] | skipCycle2};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :301:39, :312:15, :313:95]
      inReady <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 5'h1 < 5'h2 | skipCycle2;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :225:33, :277:27, :297:28, :301:39, :305:{26,28}, :313:{16,17,31,56,95}, :317:38]
      rawOutValid <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 5'h1 == 5'h1 | skipCycle2;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :226:33, :277:27, :297:28, :301:39, :305:{26,28}, :313:{16,17,31,56,95}, :317:38, :318:42]
    end
    if (entering) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:297:28]
      ...
      majorExc_Z <= io_sqrtOp ? io_a_isNaN & ~(io_a_sig[22]) | notSigNaNIn_invalidExc_S_sqrt : io_a_isNaN & ~(io_a_sig[22]) | io_b_isNaN & ~(io_b_sig[22]) | notSigNaNIn_invalidExc_S_div | ~io_a_isNaN & ~io_a_isInf & io_b_isZero;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:229:29, :254:42, :256:{9,43}, :258:12, :259:38, :261:46, :262:{36,51}, generators/hardfloat/hardfloat/src/main/scala/common.scala:82:{46,49,56}]
    ...
    if (_GEN) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:390:20]
      rem_Z <= newBit ? trialRem[25:0] : rem[25:0];	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:243:29, :358:11, :368:29, :369:23, :371:24]
      sigX_Z <= {_sigX_Z_T_3[25], _GEN_0[24], _GEN_0[23:0] | (_sigX_Z_T_7 ? {newBit, 23'h0} : 24'h0)} | (inReady ? 26'h0 : sigX_Z) | (~inReady & newBit ? _bitMask_T[27:2] : 26'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :245:29, :340:23, :342:16, :343:16, :352:12, :353:21, :360:{23,34}, :369:23, :394:{16,74}, :395:74, :396:{16,50}, :397:{16,74}, :398:{16,27}]
    end
