...
module TLError(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
  ...
  wire [7:0]      _a_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [8:0]      a_last_beats1 = _a_q_io_deq_bits_opcode[2] ? 9'h0 : ~(_a_last_beats1_decode_T[11:3]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [8:0]      r_beats1 = da_bits_opcode[0] ? ~(_r_beats1_decode_T[11:3]) : 9'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:38:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}]
  reg  [8:0]      r_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire            _q_io_deq_ready_T_3 = auto_in_d_ready & (r_counter == 9'h1 | r_beats1 == 9'h0) | ~a_last;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:{26,46,49}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
      ...
      if (_q_io_deq_ready_T_3 & _a_q_io_deq_valid) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:46, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
        if (a_last_counter == 9'h0)	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
          a_last_counter <= a_last_beats1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27]
        else	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
          a_last_counter <= a_last_counter - 9'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :230:28]
      end
      if (auto_in_d_ready & da_valid) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:36:25, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        if (r_counter == 9'h0)	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
          ...
          r_counter <= r_counter - 9'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :230:28]
      end
    end
  end // always @(posedge)
  ...
  Queue1_TLBundleA_a14d64s8k1z4u a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_deq_ready        (_q_io_deq_ready_T_3),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:46]
