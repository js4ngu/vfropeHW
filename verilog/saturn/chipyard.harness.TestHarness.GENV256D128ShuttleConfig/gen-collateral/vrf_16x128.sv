...
module vrf_16x128(	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:62:16]
  input  [3:0]   R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [127:0] Memory[0:15];	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:62:16]
    ...
    initial begin	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:62:16]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:62:16]
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM;	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:62:16]
        end	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:62:16]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
