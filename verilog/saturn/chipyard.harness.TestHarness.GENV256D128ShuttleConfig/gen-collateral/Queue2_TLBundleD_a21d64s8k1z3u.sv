...
module Queue2_TLBundleD_a21d64s8k1z3u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [82:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x83 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, 2'h0, io_enq_bits_source, io_enq_bits_size, 2'h0, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :255:14, :256:91]
  );
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[15:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_sink = _ram_ext_R0_data[16];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_denied = _ram_ext_R0_data[17];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[81:18];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[82];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
