...
module RecFNToIN_e8_s24_i64(	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:46:7]
  ...
  wire [86:0] shiftedSig = {63'h0, io_in[31], io_in[22:0]} << (io_in[31] ? io_in[28:23] : 6'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:61:30, :83:49, :84:16, :85:27, :143:12, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:61:49]
  ...
  wire [63:0] complUnroundedInt = {64{io_in[32]}} ^ shiftedSig[86:23];	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:83:49, :90:52, :103:32, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25]
  wire [63:0] _roundedInt_T_3 = roundIncr ^ io_in[32] ? complUnroundedInt + 64'h1 : complUnroundedInt;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:101:46, :103:32, :105:{12,23}, :106:31, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25]
  wire        magGeOne_atOverflowEdge = io_in[30:23] == 8'h3F;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:62:28, :110:43]
  wire        roundCarryBut2 = (&(shiftedSig[84:23])) & roundIncr;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:83:49, :90:52, :101:46, :113:{38,56,61}]
  ...
  assign io_out = rawIn_isNaN | (&(io_in[31:30])) & ~(io_in[29]) | (io_in[31] ? (|(io_in[30:29])) | (io_signedOut ? (io_in[32] ? magGeOne_atOverflowEdge & ((|(shiftedSig[85:23])) | roundIncr) : magGeOne_atOverflowEdge | io_in[30:23] == 8'h3E & roundCarryBut2) : io_in[32] | magGeOne_atOverflowEdge & shiftedSig[85] & roundCarryBut2) : ~io_signedOut & io_in[32] & roundIncr) ? {io_signedOut == excSign, {63{~excSign}}} : {_roundedInt_T_3[63:1], _roundedInt_T_3[0] | roundingMode_odd & common_inexact};	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:46:7, :61:30, :62:28, :72:53, :83:49, :90:52, :92:29, :101:46, :105:12, :108:{11,31}, :110:43, :113:61, :115:12, :116:{21,36}, :117:20, :118:24, :119:49, :120:{42,60,64}, :121:49, :122:{38,60}, :124:32, :126:{42,57}, :128:{13,41}, :137:32, :139:27, :142:11, :143:{12,13}, :145:{18,30}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:51:21, :53:{28,53}, :56:{33,41}, :57:{33,36}, :59:25]
endmodule
