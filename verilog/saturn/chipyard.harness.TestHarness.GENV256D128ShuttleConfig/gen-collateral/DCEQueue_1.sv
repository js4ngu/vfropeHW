...
module DCEQueue_1(	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
  ...
  wire [3:0][8:0]  _GEN_0 = {{ram_0_vconfig_vl}, {ram_2_vconfig_vl}, {ram_1_vconfig_vl}, {ram_0_vconfig_vl}};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16, :57:15]
  ...
  wire [3:0][7:0]  _GEN_4 = {{ram_0_vstart}, {ram_2_vstart}, {ram_1_vstart}, {ram_0_vstart}};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16, :57:15]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    ...
    initial begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
        ...
        ram_0_vconfig_vl = _RANDOM[6'h2][19:11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vconfig_vtype_vsew = _RANDOM[6'h4][16:14];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vconfig_vtype_vlmul_sign = _RANDOM[6'h4][17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vconfig_vtype_vlmul_mag = _RANDOM[6'h4][19:18];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vstart = _RANDOM[6'h4][27:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_segstart = _RANDOM[6'h4][30:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_segend = {_RANDOM[6'h4][31], _RANDOM[6'h5][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rs1_data = {_RANDOM[6'h5][31:2], _RANDOM[6'h6], _RANDOM[6'h7][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vat = _RANDOM[6'h9][26:22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rm = _RANDOM[6'h9][29:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_emul = _RANDOM[6'h9][31:30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_debug_id = _RANDOM[6'hA][16:1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_mop = _RANDOM[6'hA][18:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_reduction = _RANDOM[6'hA][19];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_scalar_to_vd0 = _RANDOM[6'hA][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_wide_vd = _RANDOM[6'hA][21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_wide_vs2 = _RANDOM[6'hA][22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_writes_mask = _RANDOM[6'hA][23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_reads_vs1_mask = _RANDOM[6'hA][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_reads_vs2_mask = _RANDOM[6'hA][25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_nf_log2 = _RANDOM[6'hA][28:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renv1 = _RANDOM[6'hA][29];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renv2 = _RANDOM[6'hA][30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renvd = _RANDOM[6'hA][31];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renvm = _RANDOM[6'hB][0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_wvd = _RANDOM[6'hB][1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_seq = _RANDOM[6'hB][2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_bits = {_RANDOM[6'hC][31:11], _RANDOM[6'hD][10:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vl = _RANDOM[6'hD][19:11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vsew = _RANDOM[6'hF][16:14];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vlmul_sign = _RANDOM[6'hF][17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vlmul_mag = _RANDOM[6'hF][19:18];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vstart = _RANDOM[6'hF][27:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_segstart = _RANDOM[6'hF][30:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_segend = {_RANDOM[6'hF][31], _RANDOM[6'h10][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rs1_data = {_RANDOM[6'h10][31:2], _RANDOM[6'h11], _RANDOM[6'h12][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vat = _RANDOM[6'h14][26:22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rm = _RANDOM[6'h14][29:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_emul = _RANDOM[6'h14][31:30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_debug_id = _RANDOM[6'h15][16:1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_mop = _RANDOM[6'h15][18:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_reduction = _RANDOM[6'h15][19];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_scalar_to_vd0 = _RANDOM[6'h15][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_wide_vd = _RANDOM[6'h15][21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_wide_vs2 = _RANDOM[6'h15][22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_writes_mask = _RANDOM[6'h15][23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_reads_vs1_mask = _RANDOM[6'h15][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_reads_vs2_mask = _RANDOM[6'h15][25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_nf_log2 = _RANDOM[6'h15][28:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renv1 = _RANDOM[6'h15][29];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renv2 = _RANDOM[6'h15][30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renvd = _RANDOM[6'h15][31];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renvm = _RANDOM[6'h16][0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_wvd = _RANDOM[6'h16][1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_seq = _RANDOM[6'h16][2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_bits = {_RANDOM[6'h17][31:11], _RANDOM[6'h18][10:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vl = _RANDOM[6'h18][19:11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vsew = _RANDOM[6'h1A][16:14];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vlmul_sign = _RANDOM[6'h1A][17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vlmul_mag = _RANDOM[6'h1A][19:18];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vstart = _RANDOM[6'h1A][27:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_segstart = _RANDOM[6'h1A][30:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_segend = {_RANDOM[6'h1A][31], _RANDOM[6'h1B][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_rs1_data = {_RANDOM[6'h1B][31:2], _RANDOM[6'h1C], _RANDOM[6'h1D][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vat = _RANDOM[6'h1F][26:22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_rm = _RANDOM[6'h1F][29:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_emul = _RANDOM[6'h1F][31:30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_debug_id = _RANDOM[6'h20][16:1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_mop = _RANDOM[6'h20][18:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_reduction = _RANDOM[6'h20][19];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_scalar_to_vd0 = _RANDOM[6'h20][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_wide_vd = _RANDOM[6'h20][21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_wide_vs2 = _RANDOM[6'h20][22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_writes_mask = _RANDOM[6'h20][23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_reads_vs1_mask = _RANDOM[6'h20][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_reads_vs2_mask = _RANDOM[6'h20][25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_nf_log2 = _RANDOM[6'h20][28:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renv1 = _RANDOM[6'h20][29];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renv2 = _RANDOM[6'h20][30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renvd = _RANDOM[6'h20][31];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renvm = _RANDOM[6'h21][0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_wvd = _RANDOM[6'h21][1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_seq = _RANDOM[6'h21][2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        enq_ptr_value = _RANDOM[6'h21][4:3];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h21][6:5];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h21][7];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, :27:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
