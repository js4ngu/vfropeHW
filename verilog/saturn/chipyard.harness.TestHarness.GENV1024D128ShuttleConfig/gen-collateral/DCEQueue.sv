...
module DCEQueue(	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
  ...
  reg  [10:0]      ram_3_vconfig_vl;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  ...
  reg  [9:0]       ram_3_vstart;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  ...
  wire [3:0][10:0] _GEN_0 = {{ram_3_vconfig_vl}, {ram_2_vconfig_vl}, {ram_1_vconfig_vl}, {ram_0_vconfig_vl}};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16, :57:15]
  ...
  wire [3:0][9:0]  _GEN_4 = {{ram_3_vstart}, {ram_2_vstart}, {ram_1_vstart}, {ram_0_vstart}};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16, :57:15]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    ...
    initial begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
        ...
        ram_0_vconfig_vl = _RANDOM[6'h2][22:12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vconfig_vtype_vsew = _RANDOM[6'h4][19:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vconfig_vtype_vlmul_sign = _RANDOM[6'h4][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vconfig_vtype_vlmul_mag = _RANDOM[6'h4][22:21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vstart = {_RANDOM[6'h4][31:23], _RANDOM[6'h5][0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_segstart = _RANDOM[6'h5][3:1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_segend = _RANDOM[6'h5][6:4];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rs1_data = {_RANDOM[6'h5][31:7], _RANDOM[6'h6], _RANDOM[6'h7][6:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vat = _RANDOM[6'h9][31:27];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rm = _RANDOM[6'hA][2:0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_emul = _RANDOM[6'hA][4:3];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_debug_id = _RANDOM[6'hA][21:6];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_mop = _RANDOM[6'hA][23:22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_bits = _RANDOM[6'hC];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vl = _RANDOM[6'hD][10:0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vsew = _RANDOM[6'hF][7:5];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vlmul_sign = _RANDOM[6'hF][8];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vlmul_mag = _RANDOM[6'hF][10:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vstart = _RANDOM[6'hF][20:11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_segstart = _RANDOM[6'hF][23:21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_segend = _RANDOM[6'hF][26:24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rs1_data = {_RANDOM[6'hF][31:27], _RANDOM[6'h10], _RANDOM[6'h11][26:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vat = _RANDOM[6'h14][19:15];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rm = _RANDOM[6'h14][22:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_emul = _RANDOM[6'h14][24:23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_debug_id = {_RANDOM[6'h14][31:26], _RANDOM[6'h15][9:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_mop = _RANDOM[6'h15][11:10];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_bits = {_RANDOM[6'h16][31:20], _RANDOM[6'h17][19:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vl = _RANDOM[6'h17][30:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vsew = _RANDOM[6'h19][27:25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vlmul_sign = _RANDOM[6'h19][28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vlmul_mag = _RANDOM[6'h19][30:29];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vstart = {_RANDOM[6'h19][31], _RANDOM[6'h1A][8:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_segstart = _RANDOM[6'h1A][11:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_segend = _RANDOM[6'h1A][14:12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_rs1_data = {_RANDOM[6'h1A][31:15], _RANDOM[6'h1B], _RANDOM[6'h1C][14:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vat = _RANDOM[6'h1F][7:3];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_rm = _RANDOM[6'h1F][10:8];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_emul = _RANDOM[6'h1F][12:11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_debug_id = _RANDOM[6'h1F][29:14];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_mop = _RANDOM[6'h1F][31:30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_bits = {_RANDOM[6'h21][31:8], _RANDOM[6'h22][7:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_vconfig_vl = _RANDOM[6'h22][18:8];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_vconfig_vtype_vsew = _RANDOM[6'h24][15:13];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_vconfig_vtype_vlmul_sign = _RANDOM[6'h24][16];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_vconfig_vtype_vlmul_mag = _RANDOM[6'h24][18:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_vstart = _RANDOM[6'h24][28:19];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_segstart = _RANDOM[6'h24][31:29];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_segend = _RANDOM[6'h25][2:0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_rs1_data = {_RANDOM[6'h25][31:3], _RANDOM[6'h26], _RANDOM[6'h27][2:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_vat = _RANDOM[6'h29][27:23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_rm = _RANDOM[6'h29][30:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_emul = {_RANDOM[6'h29][31], _RANDOM[6'h2A][0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_debug_id = _RANDOM[6'h2A][17:2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_3_mop = _RANDOM[6'h2A][19:18];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        enq_ptr_value = _RANDOM[6'h2A][21:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h2A][23:22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h2A][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, :27:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
