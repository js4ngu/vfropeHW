...
module Queue1_TLBundleA_a26d64s12k1z2u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [11:0] io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [25:0] io_enq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [11:0] io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [25:0] io_deq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  reg  [118:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][23:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_param = ram[5:3];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_size = ram[7:6];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_source = ram[19:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = ram[45:20];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = ram[53:46];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = ram[117:54];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = ram[118];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
