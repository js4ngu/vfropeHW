...
module LoadSequencer(	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7]
  ...
  wire [7:0]   _io_iss_bits_wvd_eg_T_7;	// @[generators/saturn/src/main/scala/common/Parameters.scala:344:10]
  wire         _io_iss_valid_output;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:64:41]
  wire [2:0]   _eidx_9to7;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, generators/saturn/src/main/scala/common/Parameters.scala:343:20]
  ...
  reg  [10:0]  inst_vconfig_vl;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:12:18]
  ...
  reg  [9:0]   eidx;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:13:18]
  reg  [2:0]   sidx;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:14:18]
  reg  [255:0] wvd_mask;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:15:21]
  reg  [7:0]   rvm_mask;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:16:21]
  ...
  wire [17:0]  _next_eidx_next_T_14 = {7'h0, {1'h0, eidx >> _next_eidx_next_T_8} + 11'h1} << _next_eidx_next_T_8;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:13:18, generators/saturn/src/main/scala/backend/PipeSequencer.scala:54:{15,33,52,60}, :64:21]
  wire [10:0]  next_eidx = inst_vconfig_vl > _next_eidx_next_T_14[10:0] ? _next_eidx_next_T_14[10:0] : inst_vconfig_vl;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:12:18, generators/saturn/src/main/scala/backend/PipeSequencer.scala:40:{34,37}, :52:10, :54:60]
  wire         tail = next_eidx == inst_vconfig_vl & sidx == (~(|(inst_bits[27:26])) & inst_bits[24:20] == 5'h8 ? 3'h0 : inst_bits[31:29]);	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18, :14:18, :21:{29,49,57}, generators/saturn/src/main/scala/backend/PipeSequencer.scala:40:34, generators/saturn/src/main/scala/common/Bundles.scala:61:22, :62:18, :63:16, :64:{21,33,41}, :65:19]
  ...
  wire [255:0] _rvm_mask_T_4 = 256'h1 << _eidx_9to7;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, generators/saturn/src/main/scala/common/Parameters.scala:343:20, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire [255:0] vd_write_oh = 256'h1 << _io_iss_bits_wvd_eg_T_7;	// @[generators/saturn/src/main/scala/common/Parameters.scala:344:10, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign _eidx_9to7 = eidx[9:7];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:13:18, :34:23, generators/saturn/src/main/scala/common/Parameters.scala:343:20]
  assign _io_iss_valid_output = valid & ~((|((inst_bits[25] ? 256'h0 : _rvm_mask_T_4) & io_older_writes)) | (|(vd_write_oh & io_older_writes)) | (|(vd_write_oh & io_older_reads))) & (inst_bits[25] | io_rvm_req_ready);	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:11:22, :12:18, :52:24, :55:{32,51}, :56:{33,52}, :57:{33,51}, :58:46, :64:{28,41,52}, generators/saturn/src/main/scala/common/Bundles.scala:60:16, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [9:0]   io_iss_bits_wvd_eg_off = eidx >> 3'h4 - (inst_mop[0] ? inst_vconfig_vtype_vsew : _GEN);	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:12:18, :13:18, generators/saturn/src/main/scala/backend/PipeSequencer.scala:54:33, generators/saturn/src/main/scala/common/Bundles.scala:59:{26,30}, generators/saturn/src/main/scala/common/Parameters.scala:343:{20,73}]
  assign _io_iss_bits_wvd_eg_T_7 = {inst_bits[11:7] + _io_iss_bits_wvd_eg_T_1[4:0], 3'h0} + io_iss_bits_wvd_eg_off[7:0];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:12:18, :65:{44,52}, generators/saturn/src/main/scala/common/Bundles.scala:65:19, :70:17, generators/saturn/src/main/scala/common/Parameters.scala:343:20, :344:10]
  wire [16:0]  _head_mask_T_4 = {7'h0, eidx} << (inst_mop[0] ? inst_vconfig_vtype_vsew : _GEN);	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:12:18, :13:18, generators/saturn/src/main/scala/backend/PipeSequencer.scala:42:80, :54:15, generators/saturn/src/main/scala/common/Bundles.scala:59:{26,30}]
  wire [30:0]  head_mask = 31'hFFFF << _head_mask_T_4[3:0];	// @[generators/saturn/src/main/scala/backend/PipeSequencer.scala:42:{71,80,87}]
  wire [17:0]  _tail_mask_T_4 = {7'h0, next_eidx} << (inst_mop[0] ? inst_vconfig_vtype_vsew : _GEN);	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:12:18, generators/saturn/src/main/scala/backend/PipeSequencer.scala:40:34, :43:102, :54:15, generators/saturn/src/main/scala/common/Bundles.scala:59:{26,30}]
  ...
  wire [4:0]   _GEN_1 = {4'h0, group[0]};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:73:20]
  ...
  wire [4:0]   _GEN_3 = {4'h0, group_1[0]};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:73:20]
  ...
  wire [4:0]   _GEN_12 = {1'h0, 4'h8 >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21, generators/saturn/src/main/scala/common/Bundles.scala:64:41]
  ...
  wire [4:0]   _GEN_13 = {1'h0, 4'h9 >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21]
  ...
  wire [4:0]   _GEN_14 = {1'h0, 4'hA >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21]
  ...
  wire [4:0]   _GEN_15 = {1'h0, 4'hB >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21]
  ...
  wire [4:0]   _GEN_16 = {1'h0, 4'hC >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21]
  ...
  wire [4:0]   _GEN_17 = {1'h0, 4'hD >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21]
  ...
  wire [4:0]   _GEN_18 = {1'h0, 4'hE >> _GEN_11};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:34:23, :36:33, generators/saturn/src/main/scala/backend/PipeSequencer.scala:64:21]
  ...
  wire [4:0]   group_16 = 5'h10 >> _GEN_0;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :34:23, :35:34]
  ...
  wire [4:0]   group_17 = 5'h11 >> _GEN_0;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :34:23, :35:34]
  ...
  wire [4:0]   group_18 = 5'h12 >> _GEN_0;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :34:23, :35:34]
  ...
  wire [4:0]   group_19 = 5'h13 >> _GEN_0;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :34:23, :35:34]
  ...
  wire [4:0]   group_20 = 5'h14 >> _GEN_0;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :34:23, :35:34]
  ...
  wire         _GEN_22 = sidx == (~(|(inst_bits[27:26])) & inst_bits[24:20] == 5'h8 ? 3'h0 : inst_bits[31:29]);	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18, :14:18, :82:16, generators/saturn/src/main/scala/common/Bundles.scala:61:22, :62:18, :63:16, :64:{21,33,41}, :65:19]
  always @(posedge clock) begin	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7]
    ...
    if (_GEN_21 & _GEN_22)	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:25:22, :75:{21,31}, :82:{16,33}, :84:12]
      eidx <= next_eidx[9:0];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:13:18, :84:12, generators/saturn/src/main/scala/backend/PipeSequencer.scala:40:34]
    ...
    if (~_GEN_21 | next_eidx >> _offset_T == {1'h0, eidx >> _offset_T}) begin	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:13:18, :25:22, :75:{21,31}, :76:101, :77:16, generators/saturn/src/main/scala/backend/PipeSequencer.scala:40:34, :59:62, :60:{16,27,37}, :64:21]
      if (_GEN_20)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        wvd_mask <= {{8{group_31 >= rd_group_31 & group_31 <= rd_group_31 + _GEN_2}}, {8{group_30 >= rd_group_30 & group_30 <= rd_group_30 + _GEN_2}}, {8{group_29 >= rd_group_29 & group_29 <= rd_group_29 + _GEN_2}}, {8{group_28 >= rd_group_28 & group_28 <= rd_group_28 + _GEN_2}}, {8{group_27 >= rd_group_27 & group_27 <= rd_group_27 + _GEN_2}}, {8{group_26 >= rd_group_26 & group_26 <= rd_group_26 + _GEN_2}}, {8{group_25 >= rd_group_25 & group_25 <= rd_group_25 + _GEN_2}}, {8{group_24 >= rd_group_24 & group_24 <= rd_group_24 + _GEN_2}}, {8{group_23 >= rd_group_23 & group_23 <= rd_group_23 + _GEN_2}}, {8{group_22 >= rd_group_22 & group_22 <= rd_group_22 + _GEN_2}}, {8{group_21 >= rd_group_21 & group_21 <= rd_group_21 + _GEN_2}}, {8{group_20 >= rd_group_20 & group_20 <= rd_group_20 + _GEN_2}}, {8{group_19 >= rd_group_19 & group_19 <= rd_group_19 + _GEN_2}}, {8{group_18 >= rd_group_18 & group_18 <= rd_group_18 + _GEN_2}}, {8{group_17 >= rd_group_17 & group_17 <= rd_group_17 + _GEN_2}}, {8{group_16 >= rd_group_16 & group_16 <= rd_group_16 + _GEN_2}}, {8{_GEN_19 >= rd_group_15 & _GEN_19 <= rd_group_15 + _GEN_2}}, {8{_GEN_18 >= rd_group_14 & _GEN_18 <= rd_group_14 + _GEN_2}}, {8{_GEN_17 >= rd_group_13 & _GEN_17 <= rd_group_13 + _GEN_2}}, {8{_GEN_16 >= rd_group_12 & _GEN_16 <= rd_group_12 + _GEN_2}}, {8{_GEN_15 >= rd_group_11 & _GEN_15 <= rd_group_11 + _GEN_2}}, {8{_GEN_14 >= rd_group_10 & _GEN_14 <= rd_group_10 + _GEN_2}}, {8{_GEN_13 >= rd_group_9 & _GEN_13 <= rd_group_9 + _GEN_2}}, {8{_GEN_12 >= rd_group_8 & _GEN_12 <= rd_group_8 + _GEN_2}}, {8{_GEN_10 >= rd_group_7 & _GEN_10 <= rd_group_7 + _GEN_2}}, {8{_GEN_9 >= rd_group_6 & _GEN_9 <= rd_group_6 + _GEN_2}}, {8{_GEN_8 >= rd_group_5 & _GEN_8 <= rd_group_5 + _GEN_2}}, {8{_GEN_7 >= rd_group_4 & _GEN_7 <= rd_group_4 + _GEN_2}}, {8{_GEN_5 >= rd_group_3 & _GEN_5 <= rd_group_3 + _GEN_2}}, {8{_GEN_4 >= rd_group_2 & _GEN_4 <= rd_group_2 + _GEN_2}}, {8{_GEN_3 >= rd_group_1 & _GEN_3 <= rd_group_1 + _GEN_2}}, {8{_GEN_1 >= rd_group & _GEN_1 <= rd_group + _GEN_2}}};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:15:21, :34:23, :35:34, :36:{33,45,54,67}, :38:32]
    end
    ...
    if (~_GEN_21 | {7'h0, next_eidx[10:7]} == {8'h0, _eidx_9to7}) begin	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:25:22, :34:23, :75:{21,31}, :76:101, :79:85, :80:16, generators/saturn/src/main/scala/backend/PipeSequencer.scala:40:34, :54:15, :60:{16,27}, :65:20, :73:20, generators/saturn/src/main/scala/common/Parameters.scala:343:20, :344:10]
      if (_GEN_20)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        rvm_mask <= {8{~(io_dis_bits_bits[25])}};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:16:21, :39:{20,21}, generators/saturn/src/main/scala/common/Bundles.scala:60:16]
    end
    else	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:25:22, :75:31, :79:85]
      rvm_mask <= ~(_rvm_mask_T_4[7:0]) & rvm_mask;	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:16:21, :80:{28,30}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7]
    ...
    logic [31:0] _RANDOM[0:19];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7]
    initial begin	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7]
        ...
        valid = _RANDOM[5'h0][0];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :11:22]
        inst_bits = {_RANDOM[5'h1][31:9], _RANDOM[5'h2][8:0]};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_vconfig_vl = _RANDOM[5'h2][19:9];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_vconfig_vtype_vsew = _RANDOM[5'h4][16:14];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_segend = _RANDOM[5'h5][3:1];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_vat = _RANDOM[5'h9][28:24];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_emul = _RANDOM[5'hA][1:0];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_debug_id = _RANDOM[5'hA][18:3];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        inst_mop = _RANDOM[5'hA][20:19];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :12:18]
        eidx = _RANDOM[5'hB][13:4];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :13:18]
        sidx = _RANDOM[5'hB][16:14];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :13:18, :14:18]
        wvd_mask = {_RANDOM[5'hB][31:17], _RANDOM[5'hC], _RANDOM[5'hD], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10], _RANDOM[5'h11], _RANDOM[5'h12], _RANDOM[5'h13][16:0]};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :13:18, :15:21]
        rvm_mask = _RANDOM[5'h13][24:17];	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :15:21, :16:21]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_seq_hazard_bits_rintent = {248'h0, rvm_mask};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :16:21, :48:30]
  ...
  assign io_rvm_req_bits_eg = {5'h0, _eidx_9to7};	// @[generators/saturn/src/main/scala/backend/LoadSequencer.scala:8:7, :34:23, :61:22, generators/saturn/src/main/scala/common/Parameters.scala:343:20]
