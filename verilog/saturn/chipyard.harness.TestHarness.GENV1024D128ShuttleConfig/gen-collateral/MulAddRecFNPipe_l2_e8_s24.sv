...
module MulAddRecFNPipe_l2_e8_s24(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7]
  ...
  input  [32:0] io_a,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:638:16]
  input  [32:0] io_b,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:638:16]
  input  [32:0] io_c,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:638:16]
  input  [2:0]  io_roundingMode,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:638:16]
  output [32:0] io_out,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:638:16]
  ...
  wire [9:0]  _mulAddRecFNToRaw_postMul_io_rawOut_sExp;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:655:42]
  wire [26:0] _mulAddRecFNToRaw_postMul_io_rawOut_sig;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:655:42]
  wire [23:0] _mulAddRecFNToRaw_preMul_io_mulAddA;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
  wire [23:0] _mulAddRecFNToRaw_preMul_io_mulAddB;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
  wire [47:0] _mulAddRecFNToRaw_preMul_io_mulAddC;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
  ...
  wire [9:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_sExpSum;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
  ...
  wire [4:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_CDom_CAlignDist;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
  wire [25:0] _mulAddRecFNToRaw_preMul_io_toPostMul_highAlignedSigC;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
  ...
  reg  [9:0]  roundRawFNToRecFN_io_in_pipe_b_sExp;	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
  reg  [26:0] roundRawFNToRecFN_io_in_pipe_b_sig;	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7]
    if (io_validin) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:638:16]
      ...
      mulAddRecFNToRaw_postMul_io_mulAddResult_pipe_b <= {1'h0, {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddA} * {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41, :663:45, :664:50, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7]
    ...
    logic [31:0] _RANDOM[0:5];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7]
        ...
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isSigNaNAny = _RANDOM[3'h0][1];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isNaNAOrB = _RANDOM[3'h0][2];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isInfA = _RANDOM[3'h0][3];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isZeroA = _RANDOM[3'h0][4];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isInfB = _RANDOM[3'h0][5];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isZeroB = _RANDOM[3'h0][6];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_signProd = _RANDOM[3'h0][7];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isNaNC = _RANDOM[3'h0][8];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isInfC = _RANDOM[3'h0][9];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_isZeroC = _RANDOM[3'h0][10];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_sExpSum = _RANDOM[3'h0][20:11];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_doSubMags = _RANDOM[3'h0][21];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_CIsDominant = _RANDOM[3'h0][22];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_CDom_CAlignDist = _RANDOM[3'h0][27:23];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_highAlignedSigC = {_RANDOM[3'h0][31:28], _RANDOM[3'h1][21:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_fromPreMul_pipe_b_bit0AlignedSigC = _RANDOM[3'h1][22];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_mulAddResult_pipe_b = {_RANDOM[3'h1][31:24], _RANDOM[3'h2], _RANDOM[3'h3][8:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        mulAddRecFNToRaw_postMul_io_roundingMode_pipe_b = _RANDOM[3'h3][12:10];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundingMode_stage0_pipe_b = _RANDOM[3'h3][16:14];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        valid_stage0_pipe_v = _RANDOM[3'h3][19];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
        roundRawFNToRecFN_io_invalidExc_pipe_b = _RANDOM[3'h3][22];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_in_pipe_b_isNaN = _RANDOM[3'h3][24];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_in_pipe_b_isInf = _RANDOM[3'h3][25];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_in_pipe_b_isZero = _RANDOM[3'h3][26];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_in_pipe_b_sign = _RANDOM[3'h3][27];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_in_pipe_b_sExp = {_RANDOM[3'h3][31:28], _RANDOM[3'h4][5:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_in_pipe_b_sig = {_RANDOM[3'h4][31:6], _RANDOM[3'h5][0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        roundRawFNToRecFN_io_roundingMode_pipe_b = _RANDOM[3'h5][4:2];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        io_validout_pipe_v = _RANDOM[3'h5][7];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:633:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MulAddRecFNToRaw_preMul_e8_s24 mulAddRecFNToRaw_preMul (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:654:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul_e8_s24 mulAddRecFNToRaw_postMul (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:655:42]
  ...
  RoundRawFNToRecFN_e8_s24 roundRawFNToRecFN (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:682:35]
