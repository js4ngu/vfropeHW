...
module RRArbiter(	// @[src/main/scala/chisel3/util/Arbiter.scala:118:7]
  ...
  wire [3:0][7:0] _GEN_0 = {{io_in_3_bits_eg}, {io_in_2_bits_eg}, {io_in_1_bits_eg}, {io_in_0_bits_eg}};	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16]
  ...
  wire [1:0]      _GEN_1 = io_in_0_valid ? 2'h0 : io_in_1_valid ? 2'h1 : {1'h1, ~io_in_2_valid};	// @[src/main/scala/chisel3/util/Arbiter.scala:90:41, :92:{26,35}, :118:7]
  assign io_chosen_choice = ctrl_validMask_1 ? 2'h1 : ctrl_validMask_2 ? 2'h2 : ctrl_validMask_3 ? 2'h3 : _GEN_1;	// @[src/main/scala/chisel3/util/Arbiter.scala:82:49, :83:76, :90:41, :92:{26,35}, :94:{24,33}]
  ...
  assign io_in_2_ready = (~ctrl_validMask_1 & ~(ctrl_validMask_grantMask_lastGrant[1]) | ~_ctrl_T_4) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :81:33, :82:49, :83:76, :87:{34,50}, :118:7]
  assign io_in_3_ready = (~_ctrl_T_1 & ctrl_validMask_grantMask_3 | ~(_ctrl_T_4 | io_in_2_valid)) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :82:49, :87:{34,50}, :118:7]
