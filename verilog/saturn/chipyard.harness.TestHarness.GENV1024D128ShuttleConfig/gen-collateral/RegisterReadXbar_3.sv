...
module RegisterReadXbar_3(	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:27:7]
  ...
  input  [7:0]   io_in_0_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  input  [7:0]   io_in_1_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  input  [7:0]   io_in_2_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  input  [7:0]   io_in_3_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  input  [7:0]   io_in_4_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  input  [7:0]   io_in_5_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  output         io_out_0_req_valid,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  output [7:0]   io_out_0_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  output         io_out_1_req_valid,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  output [7:0]   io_out_1_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  output         io_out_2_req_valid,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  output [7:0]   io_out_2_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  output         io_out_3_req_valid,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  output [7:0]   io_out_3_req_bits_eg,	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:28:14]
  ...
  wire [7:0] _GEN = {2'h0, io_in_0_req_bits_eg[7:2]};	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:44:{32,56}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [7:0] _GEN_0 = {2'h0, io_in_1_req_bits_eg[7:2]};	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:44:{32,56}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [7:0] _GEN_1 = {2'h0, io_in_2_req_bits_eg[7:2]};	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:44:{32,56}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [7:0] _GEN_2 = {2'h0, io_in_3_req_bits_eg[7:2]};	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:44:{32,56}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [7:0] _GEN_3 = {2'h0, io_in_4_req_bits_eg[7:2]};	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:44:{32,56}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [7:0] _GEN_4 = {2'h0, io_in_5_req_bits_eg[7:2]};	// @[generators/saturn/src/main/scala/backend/RegisterFile.scala:44:{32,56}, src/main/scala/chisel3/util/OneHot.scala:58:35]
