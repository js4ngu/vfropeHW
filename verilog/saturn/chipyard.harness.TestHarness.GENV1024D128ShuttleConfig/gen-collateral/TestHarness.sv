...
module TestHarness(	// @[generators/chipyard/src/main/scala/harness/TestHarness.scala:19:7]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:236:11]
    always @(posedge _source_1_clk) begin	// @[generators/chipyard/src/main/scala/harness/HarnessClocks.scala:70:26, generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:236:11]
      if (~_harnessBinderReset_catcher_io_sync_reset & (|(_jtag_exit[31:1]))) begin	// @[generators/chipyard/src/main/scala/harness/HarnessBinders.scala:177:37, :184:22, :185:82, generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:236:{11,20,72}, generators/rocket-chip/src/main/scala/util/ResetCatchAndSync.scala:39:28]
        if (`ASSERT_VERBOSE_COND_)	// @[generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:236:11]
          $error("Assertion failed: *** FAILED *** (exit code = %d)\n\n    at Periphery.scala:236 assert(io.exit < 2.U, \"*** FAILED *** (exit code = %%%%d)\\n\", io.exit >> 1.U)\n", {1'h0, _jtag_exit[31:1]});	// @[generators/chipyard/src/main/scala/harness/HarnessBinders.scala:177:37, :184:22, generators/chipyard/src/main/scala/harness/TestHarness.scala:23:25, generators/rocket-chip/src/main/scala/devices/debug/Periphery.scala:236:{11,72}]
      ...
      if (~_harnessBinderReset_catcher_io_sync_reset & (|(_success_exit_sim_exit[31:1]))) begin	// @[generators/rocket-chip/src/main/scala/util/ResetCatchAndSync.scala:39:28, generators/testchipip/src/main/scala/tsi/SimTSI.scala:12:23, :20:22, :21:11]
        if (`ASSERT_VERBOSE_COND_)	// @[generators/testchipip/src/main/scala/tsi/SimTSI.scala:21:11]
          $error("Assertion failed: *** FAILED *** (exit code = %d)\n\n    at SimTSI.scala:21 assert(!error, \"*** FAILED *** (exit code = %%%%d)\\n\", exit >> 1.U)\n", {1'h0, _success_exit_sim_exit[31:1]});	// @[generators/chipyard/src/main/scala/harness/HarnessBinders.scala:177:37, generators/chipyard/src/main/scala/harness/TestHarness.scala:23:25, generators/testchipip/src/main/scala/tsi/SimTSI.scala:12:23, :20:22, :21:{11,62}]
  ...
  SimJTAG #(
    ...
    .jtag_TDO_driven (1'h1),	// @[generators/chipyard/src/main/scala/harness/HarnessBinders.scala:177:37]
  ...
  ClockSourceAtFreqMHz #(
    ...
    .power (1'h1),	// @[generators/chipyard/src/main/scala/harness/HarnessBinders.scala:177:37]
