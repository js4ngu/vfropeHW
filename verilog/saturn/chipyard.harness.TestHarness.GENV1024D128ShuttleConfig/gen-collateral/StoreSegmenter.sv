...
module StoreSegmenter(	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7]
  ...
  input  [9:0]   io_op_vstart,	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:12:14]
  input  [10:0]  io_op_vl,	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:12:14]
  ...
  reg  [9:0]   r_eidx;	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:24:19]
  ...
  wire [9:0]   eidx = r_head ? io_op_vstart : r_eidx;	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:24:19, :25:23, :27:17]
  ...
  wire [24:0]  _eidx_incr_T_1 = {15'h0, eidx} << _eidx_incr_T_5;	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:27:17, :34:{37,50}]
  ...
  wire [10:0]  next_eidx = {1'h0, eidx} + {6'h0, eidx_incr};	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7, :27:17, :34:83, :35:24]
  ...
  wire [12:0]  _io_compactor_bits_head_T = {3'h0, eidx} << io_op_elem_size;	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:27:17, :28:17, :50:61]
  ...
  wire [13:0]  _io_compactor_bits_tail_T = {3'h0, io_op_vl} << io_op_elem_size;	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:28:17, :68:54]
  ...
  always @(posedge clock) begin	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7]
    if (_GEN_2) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      if (_GEN_3) begin	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:75:32]
        ...
        r_eidx <= next_eidx[9:0];	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:24:19, :35:24, :79:14]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7]
    ...
    initial begin	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7]
        ...
        r_eidx = _RANDOM[/*Zero width*/ 1'b0][9:0];	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7, :24:19]
        r_head = _RANDOM[/*Zero width*/ 1'b0][10];	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7, :24:19, :25:23]
        r_sidx = _RANDOM[/*Zero width*/ 1'b0][13:11];	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7, :24:19, :26:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_compactor_bits_tail = _segbuf_io_busy ? _segbuf_io_out_bits_tail : eidx_tail ? _io_compactor_bits_tail_T[3:0] : 4'h0;	// @[generators/saturn/src/main/scala/mem/StoreSegmenter.scala:11:7, :22:22, :39:29, :67:32, :68:{33,54}]
