...
module Repeater_TLBundleD_a32d128s1k4z4u(	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
  ...
  input          io_enq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  input  [3:0]   io_enq_bits_sink,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  input          io_enq_bits_denied,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  input  [127:0] io_enq_bits_data,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  output         io_deq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  output [3:0]   io_deq_bits_sink,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  output         io_deq_bits_denied,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  output [127:0] io_deq_bits_data,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  reg          saved_source;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  reg  [3:0]   saved_sink;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  reg          saved_denied;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  reg  [127:0] saved_data;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  ...
  wire         _GEN = ~full & io_enq_valid & io_repeat;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:21, :25:35, :29:21]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    if (reset)	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      full <= ~(_io_deq_valid_output & ~io_repeat) & (_GEN | full);	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:21, :24:32, :29:{21,36,43}, :30:{21,24,36,43}]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    ...
    logic [31:0] _RANDOM[0:4];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
        ...
        full = _RANDOM[3'h0][0];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21]
        saved_opcode = _RANDOM[3'h0][3:1];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_param = _RANDOM[3'h0][5:4];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_size = _RANDOM[3'h0][9:6];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_source = _RANDOM[3'h0][10];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_sink = _RANDOM[3'h0][14:11];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_denied = _RANDOM[3'h0][15];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_data = {_RANDOM[3'h0][31:16], _RANDOM[3'h1], _RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4][15:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_corrupt = _RANDOM[3'h4][16];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_enq_ready = ~full;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :25:35]
