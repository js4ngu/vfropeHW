...
module TLAFromBeat_SerialRAM_a64d64s8k8z8c(	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
  ...
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
    if (reset)	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
      is_const <= 1'h1;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:88:25, :112:7]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
    ...
    logic [31:0] _RANDOM[0:0];	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
    initial begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:112:7]
        is_const = _RANDOM[/*Zero width*/ 1'b0][0];	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:88:25, :112:7]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_beat_ready = _io_beat_ready_output;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:91:30, :112:7]
endmodule
