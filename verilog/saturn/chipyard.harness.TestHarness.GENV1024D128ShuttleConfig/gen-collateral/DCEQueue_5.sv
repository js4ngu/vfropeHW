...
module DCEQueue_5(	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
  ...
  input  [9:0]   io_enq_bits_eidx,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  input  [1:0]   io_enq_bits_rvs2_eew,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  input  [10:0]  io_enq_bits_vl,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  ...
  output [9:0]   io_deq_bits_eidx,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  output [1:0]   io_deq_bits_rvs2_eew,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  output [10:0]  io_deq_bits_vl,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  ...
  reg  [9:0]   ram_0_eidx;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [1:0]   ram_0_rvs2_eew;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [10:0]  ram_0_vl;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  ...
  reg  [9:0]   ram_1_eidx;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [1:0]   ram_1_rvs2_eew;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [10:0]  ram_1_vl;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    ...
    initial begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
        ...
        ram_0_eidx = _RANDOM[5'h4][13:4];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rvs2_eew = _RANDOM[5'h4][15:14];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vl = _RANDOM[5'h8][27:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_tail = _RANDOM[5'h8][28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rvs2_data = {_RANDOM[5'h8][31], _RANDOM[5'h9], _RANDOM[5'hA], _RANDOM[5'hB], _RANDOM[5'hC][30:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_eidx = {_RANDOM[5'hC][31], _RANDOM[5'hD][8:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rvs2_eew = _RANDOM[5'hD][10:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vl = _RANDOM[5'h11][22:12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_tail = _RANDOM[5'h11][23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        wrap_1 = _RANDOM[5'h11][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        wrap = _RANDOM[5'h11][25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[5'h11][26];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, :27:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
