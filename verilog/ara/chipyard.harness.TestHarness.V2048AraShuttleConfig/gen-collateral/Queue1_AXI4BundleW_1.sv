...
module Queue1_AXI4BundleW_1(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [63:0]  io_enq_bits_strb,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [63:0]  io_deq_bits_strb,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output         io_deq_bits_last	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
);

  reg  [576:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    ...
    logic [31:0] _RANDOM[0:18];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
        ...
        ram = {_RANDOM[5'h0][31:1], _RANDOM[5'h1], _RANDOM[5'h2], _RANDOM[5'h3], _RANDOM[5'h4], _RANDOM[5'h5], _RANDOM[5'h6], _RANDOM[5'h7], _RANDOM[5'h8], _RANDOM[5'h9], _RANDOM[5'hA], _RANDOM[5'hB], _RANDOM[5'hC], _RANDOM[5'hD], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10], _RANDOM[5'h11], _RANDOM[5'h12][1:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_data = full ? ram[511:0] : io_enq_bits_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19]
  assign io_deq_bits_strb = full ? ram[575:512] : io_enq_bits_strb;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19]
  assign io_deq_bits_last = full ? ram[576] : io_enq_bits_last;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19]
endmodule
