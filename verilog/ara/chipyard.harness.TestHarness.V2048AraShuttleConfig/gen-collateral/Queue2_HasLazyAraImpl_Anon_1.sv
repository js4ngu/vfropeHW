...
module Queue2_HasLazyAraImpl_Anon_1(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [34:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x35 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_trans_id, io_enq_bits_result})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  );
  ...
  assign io_deq_bits_result = _ram_ext_R0_data[31:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_trans_id = _ram_ext_R0_data[34:32];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
