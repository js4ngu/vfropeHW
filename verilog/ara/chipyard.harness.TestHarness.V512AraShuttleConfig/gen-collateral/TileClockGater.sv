...
module TileClockGater(	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:27:25]
  ...
  input  [12:0] auto_clock_gater_in_1_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [12:0] auto_clock_gater_in_1_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire       out_front_bits_read = auto_clock_gater_in_1_a_bits_opcode == 3'h4;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36]
  wire       _out_out_bits_data_T_1 = auto_clock_gater_in_1_a_bits_address[11:3] == 9'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:75:19, :87:24]
  assign _out_wofireMux_T_1 = ~out_front_bits_read;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :87:24]
  wire [2:0] clock_gaterIn_1_d_bits_opcode = {2'h0, out_front_bits_read};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :105:19]
  TLMonitor_64 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_opcode  (clock_gaterIn_1_d_bits_opcode),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:105:19]
  ...
  AsyncResetRegVec_w1_i1 regs_0 (	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:33:53]
    ...
    .io_q  (_regs_0_io_q),
    .io_en (auto_clock_gater_in_1_a_valid & auto_clock_gater_in_1_d_ready & _out_wofireMux_T_1 & _out_out_bits_data_T_1 & auto_clock_gater_in_1_a_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  );
  ...
  assign auto_clock_gater_in_1_d_bits_opcode = clock_gaterIn_1_d_bits_opcode;	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:27:25, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:105:19]
  ...
  assign auto_clock_gater_in_1_d_bits_data = {63'h0, _out_out_bits_data_T_1 & _regs_0_io_q};	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:27:25, :33:53, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
