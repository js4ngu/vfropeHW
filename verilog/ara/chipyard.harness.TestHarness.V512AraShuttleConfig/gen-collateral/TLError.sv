...
module TLError(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:21:9]
  ...
  wire [8:0]      _a_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue1_TLBundleA_a14d64s9k1z4u a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
