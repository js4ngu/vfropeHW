...
module Repeater_TLBundleA_a29d128s8k1z4u(	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
  ...
  input  [7:0]   io_enq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  output [7:0]   io_deq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  reg  [7:0]   saved_source;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    ...
    logic [31:0] _RANDOM[0:6];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
        ...
        saved_source = _RANDOM[3'h0][18:11];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_address = {_RANDOM[3'h0][31:19], _RANDOM[3'h1][15:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_mask = _RANDOM[3'h1][31:16];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_data = {_RANDOM[3'h2], _RANDOM[3'h3], _RANDOM[3'h4], _RANDOM[3'h5]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_corrupt = _RANDOM[3'h6][0];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
