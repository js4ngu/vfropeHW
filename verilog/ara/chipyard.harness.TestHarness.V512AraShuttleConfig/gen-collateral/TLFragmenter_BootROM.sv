...
module TLFragmenter_BootROM(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
    ...
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
      ...
      if (_GEN_0) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        if (dFirst)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:205:29]
          ...
          acknum <= acknum - 3'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29, :221:55]
      end
  ...
  TLMonitor_28 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_source  (auto_anon_out_d_bits_source[12:4])	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:238:47]
  );
  Repeater_TLBundleA_a17d64s9k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[16:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:3]), 3'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:243:{71,76}]
