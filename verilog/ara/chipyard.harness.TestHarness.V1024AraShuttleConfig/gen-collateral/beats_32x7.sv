...
module beats_32x7(	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
  input  [4:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [6:0] R0_data,
  ...
  reg [6:0] Memory[0:31];	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
    ...
    initial begin	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          ...
          Memory[i[4:0]] = _RANDOM_MEM[6:0];	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
        end	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 7'bx;	// @[generators/ara/src/main/scala/UnsafeAXI4ToTL.scala:367:26]
endmodule
