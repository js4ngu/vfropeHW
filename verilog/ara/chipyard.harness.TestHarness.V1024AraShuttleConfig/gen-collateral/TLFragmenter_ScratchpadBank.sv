...
module TLFragmenter_ScratchpadBank(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  TLMonitor_61 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_d_bits_source  (auto_anon_out_d_bits_source[8:4])	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:238:47]
  );
