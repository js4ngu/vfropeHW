...
module DivSqrtRawFN_small_e5_s11(	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
  ...
  wire [12:0] _trialTerm_T_3 = inReady & ~io_sqrtOp ? {io_b_sig, 1'h0} : 13'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5, :225:33, :271:33, :352:12, :362:{12,21,48}]
  wire [12:0] _trialTerm_T_9 = {_trialTerm_T_3[12], _trialTerm_T_3[11:0] | {inReady & io_sqrtOp & ~(io_a_sExp[0]), 11'h0}} | (_sigX_Z_T_7 ? 13'h1400 : 13'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :291:{35,48}, :342:16, :352:12, :353:21, :362:{12,74}, :363:{12,21,74}, :364:12]
  wire [15:0] trialRem = {2'h0, rem} - {2'h0, {1'h0, _trialTerm_T_9[12], _trialTerm_T_9[11] | ~inReady & ~sqrtOp_Z, _trialTerm_T_9[10:0] | (inReady ? 11'h0 : fractB_Z)} | (~inReady & sqrtOp_Z ? {sigX_Z, 1'h0} : 14'h0)};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5, :225:33, :228:29, :236:29, :245:29, :340:23, :342:16, :353:12, :358:11, :363:74, :364:74, :365:{12,74}, :366:{23,26,74}, :367:{12,23,44}, :368:29]
  ...
  wire [12:0] _sigX_Z_T_3 = inReady & ~io_sqrtOp ? {newBit, 12'h0} : 13'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :271:33, :352:12, :363:12, :369:23, :394:{16,25,50}]
  wire [11:0] _GEN_0 = _sigX_Z_T_3[11:0] | {inReady & io_sqrtOp, 11'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :342:16, :394:{16,74}, :395:{16,25}]
  always @(posedge clock) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
    if (reset) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:199:5]
      ...
      cycleNum <= {_cycleNum_T_15[3:1], _cycleNum_T_15[0] | skipCycle2};	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :301:39, :312:15, :313:95]
      inReady <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 4'h1 < 4'h2 | skipCycle2;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :225:33, :277:27, :297:28, :301:39, :305:{26,28}, :313:{16,17,31,56,95}, :317:38]
      rawOutValid <= entering & ~normalCase_S | ~entering & ~skipCycle2 & cycleNum - 4'h1 == 4'h1 | skipCycle2;	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :226:33, :277:27, :297:28, :301:39, :305:{26,28}, :313:{16,17,31,56,95}, :317:38, :318:42]
    end
    ...
    if (_GEN) begin	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:390:20]
      rem_Z <= newBit ? trialRem[12:0] : rem[12:0];	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:243:29, :358:11, :368:29, :369:23, :371:24]
      sigX_Z <= {_sigX_Z_T_3[12], _GEN_0[11], _GEN_0[10:0] | (_sigX_Z_T_7 ? {newBit, 10'h0} : 11'h0)} | (inReady ? 13'h0 : sigX_Z) | (~inReady & newBit ? _bitMask_T[14:2] : 13'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:225:33, :245:29, :340:23, :342:16, :343:16, :352:12, :353:21, :360:{23,34}, :369:23, :394:{16,74}, :395:74, :396:{16,50}, :397:{16,74}, :398:{16,27}]
    end
