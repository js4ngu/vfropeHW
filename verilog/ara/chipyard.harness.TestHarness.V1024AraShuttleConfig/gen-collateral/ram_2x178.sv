...
module ram_2x178(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input          R0_addr,
  input          R0_en,
  input          R0_clk,
  output [177:0] R0_data,
  input          W0_addr,
  input          W0_en,
  input          W0_clk,
  input  [177:0] W0_data
  ...
  reg [177:0] Memory[0:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          ...
          Memory[i[0]] = _RANDOM_MEM[177:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 178'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
