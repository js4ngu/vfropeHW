...
module Queue6_ShuttleDMemResp(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_6x74 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_size, io_enq_bits_data, io_enq_bits_tag, 1'h1})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  );
