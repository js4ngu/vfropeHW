...
module UARTRx_TestHarness_UNIQUIFIED(	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:28:7]
  ...
  input         io_en,	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:29:14]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:28:7]
    ...
    if (state | _GEN)	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:114:22, :116:18, :122:21, :124:29, :125:17]
      prescaler <= (restore ? {1'h0, io_div[15:4]} : prescaler) - {12'h0, ~(restore & sample_count < io_div[3:0])};	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:28:7, :61:32, :63:22, :72:32, :73:25, :88:25, :89:30, :98:23, :99:{25,42}, :100:{37,42,51}]
    if (state) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UARTRx.scala:114:22]
