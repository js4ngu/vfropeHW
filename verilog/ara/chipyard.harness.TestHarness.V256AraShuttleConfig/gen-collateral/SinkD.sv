...
module SinkD(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
  ...
  wire [3:0]  _d_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire        _io_resp_valid_T_1 = _q_io_deq_ready_T_2 & _d_q_io_deq_valid;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:63:30, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
  ...
  wire [2:0]  r_beats1 = _d_q_io_deq_bits_opcode[0] ? ~(_r_beats1_decode_T[5:3]) : 3'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign _q_io_deq_ready_T_2 = io_bs_adr_ready & ((|r_counter) | io_grant_safe);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:63:{30,41}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:10]
    always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:10]
      if (~reset & _d_q_io_deq_valid & _d_q_io_deq_bits_corrupt & ~_d_q_io_deq_bits_denied) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:82:{10,42}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
    ...
    else if (_io_resp_valid_T_1) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
    ...
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7]
        ...
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][6:3];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :57:53, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][9:7];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:34:7, :78:54, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue2_TLBundleD_a32d64s4k3z3c d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
