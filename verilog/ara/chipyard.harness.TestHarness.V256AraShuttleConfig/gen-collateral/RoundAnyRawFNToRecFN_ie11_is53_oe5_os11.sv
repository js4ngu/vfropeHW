...
module RoundAnyRawFNToRecFN_ie11_is53_oe5_os11(	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:48:5]
  ...
  input  [53:0] io_in_sig,	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:58:16]
  ...
  wire [13:0] sAdjustedExp = {io_in_sExp[12], io_in_sExp} - 14'h7E0;	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:110:24]
  ...
  wire [12:0] roundedSig = _overflow_roundMagUp_T & (|_roundPosBit_T) | roundMagUp & anyRound ? {1'h0, io_in_sig[53] | roundMask_shift[7], io_in_sig[52] | roundMask_shift[8], io_in_sig[51] | roundMask_shift[9], io_in_sig[50:49] | _GEN, io_in_sig[48] | roundMask_shift[12], io_in_sig[47] | roundMask_shift[13], io_in_sig[46] | roundMask_shift[14], io_in_sig[45] | roundMask_shift[15], io_in_sig[44] | roundMask_shift[16], io_in_sig[43] | roundMask_shift[17], io_in_sig[42] | roundMask_shift[18]} + 13'h1 & ~(roundingMode_near_even & (|_roundPosBit_T) & ~(|_anyRoundExtra_T) ? {roundMask_shift[7], roundMask_shift[8], roundMask_shift[9], roundMask_shift[10], roundMask_shift[11], roundMask_shift[12], roundMask_shift[13], roundMask_shift[14], roundMask_shift[15], roundMask_shift[16], roundMask_shift[17], roundMask_shift[18], 1'h1} : 13'h0) : {1'h0, io_in_sig[53:42] & {~(roundMask_shift[7]), ~(roundMask_shift[8]), ~(roundMask_shift[9]), ~_GEN, ~(roundMask_shift[12]), ~(roundMask_shift[13]), ~(roundMask_shift[14]), ~(roundMask_shift[15]), ~(roundMask_shift[16]), ~(roundMask_shift[17]), ~(roundMask_shift[18])}} | (roundingMode_odd & anyRound ? _GEN_0 & _GEN_1 : 13'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:58:16, :90:53, :95:53, :98:42, :159:42, :162:53, :163:{28,46}, :164:{40,56}, :165:{42,62}, :166:36, :169:{38,67}, :170:31, :171:29, :173:16, :174:{32,49,57}, :175:{21,25,64}, :176:30, :177:35, :180:{30,43,47}, :181:{24,42,67}, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, :77:20, :78:22]
  wire [14:0] sRoundedExp = {sAdjustedExp[13], sAdjustedExp} + {13'h0, roundedSig[12:11]};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:110:24, :173:16, :175:25, :185:{40,54}]
  wire        common_totalUnderflow = $signed(sRoundedExp) < 15'sh8;	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:185:40, :200:31]
  ...
  wire        overflow = commonCase & $signed(sRoundedExp[14:4]) > 11'sh2;	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:185:40, :196:{30,50}, :237:61, :238:32]
  ...
  assign io_out = {~isNaNOut & io_in_sign, sRoundedExp[5:0] & ~(io_in_isZero | common_totalUnderflow ? 6'h38 : 6'h0) & ~(pegMinNonzeroMagOut ? 6'h37 : 6'h0) & {1'h1, ~pegMaxFiniteMagOut, 4'hF} & {2'h3, ~notNaN_isInfOut, 3'h7} | {2'h0, pegMinNonzeroMagOut, 3'h0} | (pegMaxFiniteMagOut ? 6'h2F : 6'h0) | (notNaN_isInfOut ? 6'h30 : 6'h0) | (isNaNOut ? 6'h38 : 6'h0), (isNaNOut | io_in_isZero | common_totalUnderflow ? {isNaNOut, 9'h0} : roundedSig[9:0]) | {10{pegMaxFiniteMagOut}}};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:48:5, :58:16, :90:53, :159:42, :173:16, :185:40, :187:37, :191:27, :200:31, :235:34, :245:45, :246:39, :248:32, :250:22, :253:{14,18,32}, :257:{14,18}, :258:19, :261:{14,18}, :264:17, :265:{14,18}, :269:16, :273:16, :277:{16,73}, :278:16, :280:{12,38}, :281:16, :283:11, :284:13, :286:33, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:77:20]
  assign io_exceptionFlags = {io_invalidExc, 1'h0, overflow, commonCase & (common_totalUnderflow | anyRound & $signed(sAdjustedExp[13:5]) < 9'sh1 & roundMask_shift[18] & ~(~(roundMask_shift[17]) & roundedSig[11] & (|_roundPosBit_T) & (_overflow_roundMagUp_T & io_in_sig[41] | roundMagUp & (|{io_in_sig[41], |(io_in_sig[40:0])})))), overflow | commonCase & (common_totalUnderflow | anyRound)};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:48:5, :58:16, :98:42, :110:24, :117:{26,60}, :164:{40,56}, :166:36, :169:38, :173:16, :200:31, :203:61, :205:{63,70}, :207:67, :208:46, :209:29, :213:27, :217:40, :220:{49,64}, :221:76, :222:27, :223:34, :227:60, :230:49, :237:61, :238:32, :239:32, :240:{28,43}, :288:66, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, :77:20, :78:22]
endmodule
