...
module Queue2_TLBundleB_a32d128s3k4z4c(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x61 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  );
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[43:12];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[59:44];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[60];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
