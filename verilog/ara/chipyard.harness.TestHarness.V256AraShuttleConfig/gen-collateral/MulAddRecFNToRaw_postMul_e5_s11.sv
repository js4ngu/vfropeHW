...
module MulAddRecFNToRaw_postMul_e5_s11(	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7]
  ...
  wire [23:0] CDom_absSigSum = io_fromPreMul_doSubMags ? ~{_sigSum_T_3, io_mulAddResult[21:11]} : {1'h0, io_fromPreMul_highAlignedSigC[12:11], _sigSum_T_3[10:0], io_mulAddResult[21:12]};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:192:16, :205:12, :206:{13,20}, :207:22, :209:{46,71}, :210:23]
  ...
  wire [55:0] _notCDom_mainSig_T = {31'h0, notCDom_absSigSum} << {51'h0, notCDom_normDistReduced2, 1'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:207:22, :234:12, :243:27, src/main/scala/chisel3/util/Mux.scala:50:70]
  ...
  wire        notCDom_completeCancellation = _notCDom_mainSig_T[25:24] == 2'h0;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:222:72, :223:73, :243:27, :255:{21,50}]
  ...
  assign io_rawOut_sExp = io_fromPreMul_CIsDominant ? io_fromPreMul_sExpSum - {6'h0, io_fromPreMul_doSubMags} : io_fromPreMul_sExpSum - {2'h0, notCDom_normDistReduced2, 1'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :203:43, :207:22, :222:72, :223:73, :241:46, :293:26, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_rawOut_sig = io_fromPreMul_CIsDominant ? {_CDom_mainSig_T[23:11], (|(_CDom_mainSig_T[10:8])) | (|({|(CDom_absSigSum[7:4]), |(CDom_absSigSum[3:0])} & {CDom_reduced4SigExtra_shift[1], CDom_reduced4SigExtra_shift[2]})) | (io_fromPreMul_doSubMags ? io_mulAddResult[10:0] != 11'h7FF : (|(io_mulAddResult[11:0])))} : {_notCDom_mainSig_T[25:13], (|(_notCDom_mainSig_T[12:10])) | (|({|{|(notCDom_absSigSum[9:8]), |(notCDom_absSigSum[7:6])}, |{|(notCDom_absSigSum[5:4]), |(notCDom_absSigSum[3:2])}, |(notCDom_absSigSum[1:0])} & {notCDom_reduced4SigExtra_shift[1], notCDom_reduced4SigExtra_shift[2], notCDom_reduced4SigExtra_shift[3]}))};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :205:12, :214:12, :215:{14,21,36}, :216:{19,37}, :219:{24,56}, :222:{36,72}, :223:73, :225:{12,25}, :226:{25,32,61}, :234:12, :243:{27,50}, :247:78, :249:11, :251:{12,28}, :252:{28,35,39}, :294:25, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, :77:20, :78:22, :103:{33,54}, :120:{33,54}]
endmodule
