...
module Queue2_TLBundleD_a32d8s1k4z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [7:0] io_enq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [7:0] io_deq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  ram_2x10 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_denied})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  );
  ...
  assign io_deq_bits_denied = _ram_ext_R0_data[0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[8:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
