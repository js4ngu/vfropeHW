...
module IDPool(	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
  input        clock,	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
  input        reset,	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
  input        io_free_valid,	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:12:14]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
      bitmap <= 8'hFF;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:18:23]
      select <= 3'h0;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:19:23]
      valid <= 1'h1;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :20:23]
    end
    else begin	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
      if (io_alloc_ready | io_free_valid) begin	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:33:24]
        ...
        valid <= (|bitmap) & ~({1'h0, {1'h0, {1'h0, bitmap[0]} + {1'h0, bitmap[1]}} + {1'h0, {1'h0, bitmap[2]} + {1'h0, bitmap[3]}}} + {1'h0, {1'h0, {1'h0, bitmap[4]} + {1'h0, bitmap[5]}} + {1'h0, {1'h0, bitmap[6]} + {1'h0, bitmap[7]}}} == 4'h1 & io_alloc_ready) | io_free_valid;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :18:23, :20:23, :29:{28,32,35,46,55,64}, :30:17]
      end
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
      `FIRRTL_BEFORE_INITIAL	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:0];	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
      `ifdef INIT_RANDOM_PROLOG_	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
        `INIT_RANDOM_PROLOG_	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
        bitmap = _RANDOM[/*Zero width*/ 1'b0][7:0];	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :18:23]
        select = _RANDOM[/*Zero width*/ 1'b0][10:8];	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :18:23, :19:23]
        valid = _RANDOM[/*Zero width*/ 1'b0][11];	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :18:23, :20:23]
        REG = _RANDOM[/*Zero width*/ 1'b0][12];	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :18:23, :51:36]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
      `FIRRTL_AFTER_INITIAL	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_alloc_valid = valid;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :20:23]
  assign io_alloc_bits = select;	// @[generators/rocket-chip/src/main/scala/util/IDPool.scala:8:7, :19:23]
endmodule
