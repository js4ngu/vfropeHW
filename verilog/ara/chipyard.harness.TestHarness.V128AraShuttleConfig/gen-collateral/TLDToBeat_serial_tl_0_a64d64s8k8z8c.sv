...
module TLDToBeat_serial_tl_0_a64d64s8k8z8c(	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
  input         clock,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
  input         reset,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
  ...
  input  [1:0]  io_protocol_bits_param,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:40:14]
  ...
  input  [7:0]  io_protocol_bits_sink,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:40:14]
  input         io_protocol_bits_denied,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:40:14]
  ...
  output [64:0] io_beat_bits_payload,	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:40:14]
  ...
  wire [1:0]   _q_io_deq_bits_param;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
  ...
  wire [7:0]   _q_io_deq_bits_sink;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
  wire         _q_io_deq_bits_denied;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
  ...
  wire         _q_io_deq_ready_T_2 = io_beat_ready & (is_body | ~(_q_io_deq_bits_opcode[0]));	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17, :60:24, :62:{35,47,50}]
  ...
  wire         _io_beat_bits_tail_output = (tail_counter == 9'h1 | tail_beats1 == 9'h0) & (is_body | ~(_q_io_deq_bits_opcode[0]));	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, :229:27, :232:{25,33,43}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17, :60:24, :62:50, :65:{35,47}]
  ...
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
    if (reset) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
      ...
      is_body <= 1'h0;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:60:24, :130:7]
    end
    else begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
      if (_q_io_deq_ready_T_2 & _q_io_deq_valid) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17, :62:35, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        if (head)	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
          head_counter <= _q_io_deq_bits_opcode[0] ? ~(_tail_beats1_decode_T[11:3]) : 9'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
      `FIRRTL_BEFORE_INITIAL	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:0];	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
    initial begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
      `ifdef INIT_RANDOM_PROLOG_	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
        `INIT_RANDOM_PROLOG_	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
        head_counter = _RANDOM[/*Zero width*/ 1'b0][8:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
        tail_counter = _RANDOM[/*Zero width*/ 1'b0][17:9];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
        is_body = _RANDOM[/*Zero width*/ 1'b0][18];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:60:24, :130:7]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
      `FIRRTL_AFTER_INITIAL	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:130:7]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  Queue1_TLBundleD_a64d64s8k8z8c q (	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_beat_valid = _q_io_deq_valid;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17, :130:7]
  assign io_beat_bits_payload = is_body ? {_q_io_deq_bits_data, _q_io_deq_bits_corrupt} : {35'h0, _q_io_deq_bits_opcode, _q_io_deq_bits_param, _q_io_deq_bits_size, _q_io_deq_bits_source, _q_io_deq_bits_sink, _q_io_deq_bits_denied};	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17, :57:18, :60:24, :66:33, :130:7]
  assign io_beat_bits_head = _io_beat_bits_head_output;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:64:35, :130:7]
  assign io_beat_bits_tail = _io_beat_bits_tail_output;	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:65:35, :130:7]
endmodule
