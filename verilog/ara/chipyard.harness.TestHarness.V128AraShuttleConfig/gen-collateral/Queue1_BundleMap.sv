...
module Queue1_BundleMap(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [4:0] io_enq_bits_tl_state_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input        io_enq_bits_extra_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input        io_deq_ready,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output       io_deq_valid,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [3:0] io_deq_bits_tl_state_size,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [4:0] io_deq_bits_tl_state_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output       io_deq_bits_extra_id	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
);

  reg  [9:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      ram <= {io_enq_bits_extra_id, io_enq_bits_tl_state_source, io_enq_bits_tl_state_size};	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][10:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_tl_state_source = ram[8:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_extra_id = ram[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
