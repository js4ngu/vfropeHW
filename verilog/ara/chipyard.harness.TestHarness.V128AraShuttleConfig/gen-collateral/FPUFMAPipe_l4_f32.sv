...
module FPUFMAPipe_l4_f32(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (io_in_valid) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
      ...
      in_in3 <= io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : {32'h0, (io_in_bits_in1[32:0] ^ io_in_bits_in2[32:0]) & 33'h100000000};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14, :708:15, :711:{32,50,57}, :714:8, :716:{21,37,46}]
    end
    if (_fma_io_validout) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:719:19]
      io_out_pipe_b_data <= {32'h0, ({33{_fma_io_out[31:29] != 3'h7}} | 33'h1EF7FFFFF) & _fma_io_out};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :413:27, :414:10, :711:50, :719:19, :729:12, src/main/scala/chisel3/util/Valid.scala:142:26]
    ...
    if (reset)	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
      io_out_pipe_v <= 1'h0;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:716:11, src/main/scala/chisel3/util/Valid.scala:141:24]
