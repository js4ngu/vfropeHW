...
module Queue2_TLBundleA_a32d128s6k4z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [5:0]   io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [31:0]  io_enq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [15:0]  io_enq_bits_mask,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [5:0]   io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [31:0]  io_deq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [15:0]  io_deq_bits_mask,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  wire [192:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x193 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, 3'h0, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :255:14, :256:91]
  );
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[15:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = _ram_ext_R0_data[47:16];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[63:48];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[191:64];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[192];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
